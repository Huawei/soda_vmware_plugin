...
public class OpenSDSStorageWatchersManager implements OpenSDSEventListener {
    private static final Logger log = Logger
            .getLogger(OpenSDSStorageWatchersManager.class);
    ...
    public OpenSDSStorageWatchersManager() {
        OpenSDSStorageEventGenerator.NEW_OPEN_SDS_STORAGE_EVENT_GENERATOR
                .addUniqueEventListener(this);
    }
    ...
    public void event(String starid, double magnitude) {
        synchronized (watchers) {
            ...
            for (PluginWatcher watcher : watchers.values()) {
                ...
                String wStarId = props
                        .getProperty(OpenSDSStorageTriggerGenerator.STAR_ID);
                String wMagnitude = props
                        .getProperty(OpenSDSStorageTriggerGenerator.MAGNITUDE);
