...
import org.opensds.storage.vro.IOpenSDSStorageListener;

import ch.dunes.vso.sdk.api.IPluginNotificationHandler;

public class OpenSDSStorageEventListener implements IOpenSDSStorageListener {
    IPluginNotificationHandler notificationHandler;
    
    public OpenSDSStorageEventListener(OpenSDSStorageRepository repository,
                                       IPluginNotificationHandler notificationHandler) {
